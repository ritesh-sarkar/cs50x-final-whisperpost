    ...
    <>
      <div className="min-h-screen bg-gray-100 flex items-center justify-center">
        <div className="relative">
          {/* Main whisper bubble */}
          <div className="relative w-40 bg-white shadow-lg rounded-full p-8 animate-pulse border border-gray-300">
          ...
          <div className="absolute inset-0 -m-8">
            <div
              className="w-32 h-32 border border-blue-500/25 rounded-full animate-ping"
              style={{ animationDelay: "0.2s" }}
            ></div>
          </div>
          <div className="absolute inset-0 -m-12">
            <div
              className="w-40 h-40 border border-gray-300/50 rounded-full animate-ping"
          ...
          <div className="absolute -top-6 left-6">
            <div
              className="w-1.5 h-1.5 bg-blue-800 rounded-full animate-bounce shadow-sm"
          ...
          <div className="mt-8 text-center">
            ...
            <div className="text-gray-500 text-base mt-2 mb-1 flex items-center justify-center space-x-1">
              <span>{state}</span>
